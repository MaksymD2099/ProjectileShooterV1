...
public class AssetManager {
    ...
    //Player
    static private ImagePattern characterPattern;
    
    //Environment
    static private ImagePattern floorPattern;
  ...
  /*  static private ImagePattern projectileLaser;
    ...
    static public void preloadAllAssets()
    {
        ...
        characterPattern = new ImagePattern(new Image(fileURL("./assets/Characters/character.gif")));
    ...
    static public ImagePattern getCharacterPattern(){return characterPattern;}
